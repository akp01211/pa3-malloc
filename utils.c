...
// This helper function is important for debugging your code. It will print out
// a list of busy and free blocks, showing their offsets, size, and if the
// previous block is busy or free.

// This function is also useful for learning about how you should be iterating
// through each block.
void vminfo() {
    ...
    while (block->size_status != VM_ENDMARK) {
        ...
        // It extracts the size from block->size_status, and sets the last two
        // bits to 0 (last two bits are used for free / busy information).
        blocksz = BLKSZ(block);
        ...
        // Prints block data: blockid, status, offset, size, and previous block
        // status
